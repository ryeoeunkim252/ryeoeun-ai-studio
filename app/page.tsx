      ...
      <div className="flex flex-1 overflow-hidden" style={{ display:'grid',gridTemplateColumns:'180px 1fr 270px' }}>
        ...
        <div className="flex flex-col overflow-hidden" style={{ background:'var(--blush-l)',borderLeft:'1px solid var(--blush-b)',height:'100%' }}>
          ...
          <div className="px-3 py-2 flex gap-1.5 flex-wrap flex-shrink-0"
            ...
            {[
              { k: '@router',   label: '@총괄실장',  c: '#c06080', bg:'rgba(192,96,128,0.1)',  b:'rgba(192,96,128,0.3)' },
              { k: '@research', label: '@전략실장',  c: '#1d9e75', bg:'rgba(29,158,117,0.1)',  b:'rgba(29,158,117,0.3)' },
              { k: '@content',  label: '@콘텐츠팀장',c: '#d85a30', bg:'rgba(216,90,48,0.1)',   b:'rgba(216,90,48,0.3)'  },
              { k: '@web',      label: '@수익화팀장',c: '#ba7517', bg:'rgba(186,117,23,0.1)',  b:'rgba(186,117,23,0.3)' },
              { k: '@ops',      label: '@자동화팀장',c: '#378add', bg:'rgba(55,138,221,0.1)',  b:'rgba(55,138,221,0.3)' },
              { k: '@edu',      label: '@데이터팀장',c: '#3b6d11', bg:'rgba(59,109,17,0.1)',   b:'rgba(59,109,17,0.3)'  },
            ].map(({ k, label, c, bg, b }) => (
