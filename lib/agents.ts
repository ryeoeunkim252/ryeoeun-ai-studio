...
// ── 라우터 시스템 프롬프트 (파이프라인용) ──────────────────────
// v3 변경: team + reason + refined_task 3가지 반환
...
라우팅 규칙:
- secretary/@비서: 스케줄, 일정, 할일, 메모, 개인 업무
- research/@Strategy: 시장조사, 트렌드 분석, 경쟁사 분석, 전략 기획
- content/@Content: 콘텐츠 기획, 글쓰기, 카피, 디자인, SNS, 마케팅
- web/@Revenue: 수익화, 제휴 마케팅, 광고, 세일즈, 사업 개발
