...
//  lib/agents.ts — v2
//  새 조직도 반영: 총괄실장 + 5개 팀
//  순서: 총괄실장 → 전략기획실 → 콘텐츠팀 → 수익화팀 → 자동화팀 → 데이터팀
// ============================================================

export type AgentId = 'router' | 'research' | 'content' | 'web' | 'ops' | 'edu'
...
- research (@Strategy):   전략기획실 (시장조사, 트렌드 분석, 경쟁사 분석, 상품 기획)
- content  (@Content):    콘텐츠팀 (콘텐츠 기획, 카피, 디자인, 채널 운영, SNS)
