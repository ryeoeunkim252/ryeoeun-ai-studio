// ============================================================
//  lib/agents.ts — v3.1
//  라우팅 규칙 강화: 비서가 콘텐츠/SNS 업무 가져가는 문제 수정
// ============================================================
...
CEO의 요청을 분석하여 가장 적합한 팀을 선택하고, 그 팀에 맞는 구체적인 업무 지시를 작성하세요.
...
secretary → 오직 이것만: 개인 일정, 캘린더, 스케줄, 할일 목록, 메모, 회의 잡기
  ❌ 절대 secretary 금지: 콘텐츠, SNS, 인스타, 유튜브, 블로그, 기획, 마케팅, 분석, 자동화

content → 반드시 이것: 인스타그램, SNS, 유튜브, 블로그, 콘텐츠 기획, 글쓰기, 카피라이팅,
  썸네일, 디자인, 채널 운영, 마케팅 콘텐츠, 포스팅, 릴스, 쇼츠, 스크립트

research → 시장조사, 트렌드 분석, 경쟁사 분석, 사업 전략 기획, 상품 아이디어

web → 수익화, 제휴 마케팅, 쿠팡파트너스, 광고, 세일즈, 매출, 사업 개발

ops → 자동화, API 연결, n8n, 워크플로우, 시스템 구축, 기술 설계

edu → 데이터 분석, 고객 관리, CRM, 리텐션, 이메일 자동화

━━━ 판단 예시 ━━━
"인스타 콘텐츠 기획해줘" → content
"내일 일정 잡아줘" → secretary
"경쟁사 분석해줘" → research
"n8n 자동화 설계해줘" → ops
"쿠팡파트너스 수익 전략" → web
...
반드시 아래 JSON 형식으로만 답하세요 (다른 텍스트 절대 금지):
{
  "team": "팀ID",
  "reason": "선택 이유 한 문장",
  "refined_task": "해당 팀의 전문성에 맞게 재정제한 구체적 업무 지시 (2-4문장, 결과물 형식/KPI 포함)"
}`
